		...
		<div className='contact-container'>
			...
			<div className='contact-content'>
				<p>
					...
					Garg Defence and Aerospace today to explore how our
					specialized drone solutions and advanced navigation and
					communication systems can strengthen your defence
					capabilities.
				</p>
